...
import OracleMiddlewareContract from './OracleMiddlewareContract.ts';
...
describe('OracleMiddlewareContract', () => {
    ...
    describe('constructor', () => {
        it('should throw an error for an invalid Ethereum address', () => {
            ...
            expect(() => new OracleMiddlewareContract(invalidAddress, mockBlockchainClient)).toThrow(
                'Invalid Ethereum address for the oracle middleware',
            );
        });

        it('should not throw an error for a valid Ethereum address', () => {
            expect(() => new OracleMiddlewareContract(mockContractAddress, mockBlockchainClient)).not.toThrow();
        });
    });
    ...
    describe('getValidationDelay', () => {
        it('should throw an error if the call fails', async () => {
            ...
            const contract = new OracleMiddlewareContract(mockContractAddress, mockBlockchainClient);
